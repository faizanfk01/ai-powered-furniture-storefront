...
export function answerSystemPrompt(input: AnswerPromptInput) {
  return [
    ...
    "     - bullets    when you are listing two or more products",
    "     1. numbers   when the order genuinely matters, such as how to order",
    "     *italic*     rarely, for a single word",
    "",
    "   The usual shape of a multi-product answer is ONE short line of",
    "   introduction, then one bullet per product, then one short closing line:",
    ...
    "",
    "   A one-product answer is a plain paragraph. Never put a single item in a",
    "   list, never bullet a sentence, and never bold a whole sentence — one or",
    "   two bold runs in a reply is the limit. Restrained and easy to read, not",
    "   decorated.",
    "",
