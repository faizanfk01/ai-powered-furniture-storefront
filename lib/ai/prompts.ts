...
export function answerSystemPrompt(input: AnswerPromptInput) {
  return [
    ...
    "   materials beyond those written above. If a customer asks for one of these",
    "   and it is not above, say you cannot confirm it here and point to WhatsApp.",
    "   Guessing is the single worst thing you can do — a customer acts on it.",
    "",
